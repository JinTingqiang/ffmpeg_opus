    ...
    ColumnLayout {
        ...
        ScrollView {
            ...
            Column {
                ...
                ProxyCard {
                    title: "基础与全局信息"; value: options.length; options: ["-h", "-version", "-formats", "-codecs", "-decoders", "-encoders", "-bsfs", "-protocols", "-filters", "-layouts", "-sample_fmts", "-colors", "-loglevel level"]
                    paramTips: ({
                        "-h": "显示帮助信息",
                ...
                ProxyCard {
                    ...
                    options: ["-i", "-f fmt", "-unit", "-pretty", "-print_format fmt", "-show_error", "-select_streams stream_spec", "-read_intervals spec", "-sexagesimal", "-of fmt"]
                    paramTips: ({
                        "-x": "设置窗口的 X 坐标（水平位置）",
                        "-y": "设置窗口的 Y 坐标（垂直位置）",
                        "-fs": "全屏显示窗口",
                ...
                ProxyCard {
                    title: "音视频流控制"
                    value: options.length
                    options: ["-show_format", "-show_format_entry key", "-show_streams", "-show_stream_tags", "-show_packets", "-show_packets_stream_id n", "-show_frames", "-show_frame_tags", "-show_chapters", "-show_programs", "-show_program_tags", "-show_stream_disposition"]
                    paramTips: ({
                        "-an": "禁用音频流",
                        "-vn": "禁用视频流",
                        "-sn": "禁用字幕流",
